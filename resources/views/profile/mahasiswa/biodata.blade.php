...
@section('title', 'Isi Biodata Mahasiswa')

@section('content')
<div class="container mt-4">
    <h1 class="fw-bold text-black">Isi Biodata Mahasiswa</h1>
    ...
    <div class="card p-4 shadow-sm rounded-4 fade-in-up mt-3">
        ...
        @error('jenis_kelamin') <small class="text-danger">{{ $message }}</small> @enderror
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="jurusan" name="jurusan" value="{{ old('jurusan', $user->jurusan) }}" required>
            </div>
